namespace Quantum
{
    ...
    public class ConnectionGUI : QuantumMonoBehaviour
    {
        /// <summary>
        ...
        async void Connect()
        {
            ...
            try
            {
                ...
                _pluginDisconnectSubscription =
                    QuantumCallback.SubscribeManual<CallbackPluginDisconnect>(m => { Disconnect(); });
        ...
        async void Disconnect()
        {
            ...
            {
                Debug.LogError(
                    $"Error disconnecting from Photon cloud or shutting down Quantum online simulation: {e.Message}");
                _state = State.Error;
            }
        }
